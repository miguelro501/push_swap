...
void	arrange_smaller_aux(t_stack *stack_a, t_stack *stack_b)
{
...
void	arrange_smaller(t_stack *stack_a, t_stack *stack_b)
{
	if (stack_b->value[0] < stack_a->value[0]
		&& stack_b->value[1] < stack_a->value[0])
	{
		if (stack_b->value[0] < stack_b->value[1])
			rotate_stack(stack_b);
		push_stack(stack_a, stack_b);
	...
	else if (stack_b->value[0] > stack_a->value[stack_a->size - 1]
		&& stack_b->value[1] > stack_a->value[stack_a->size - 1])
		arrange_smaller_aux(stack_a, stack_b);
	else
	{
		if (stack_b->value[0] > stack_a->value[0])
			rotate_stack(stack_b);
